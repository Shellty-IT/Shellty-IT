...
**DevOps:** Docker, CI/CD (GitHub Actions), Ansible, Linux
**Also:** AI integration (Gemini, RAG), Windows Server, networks
...
- 🌐 Portfolio: [shellty-it.github.io](https://shellty-it.github.io)
